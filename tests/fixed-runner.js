...
function setupMocks() {
    console.log('🔧 Setting up comprehensive mocks...');
    
    // Create jest mock first
    const jest = {
        fn: (implementation) => {
    ...
    // Make jest available globally FIRST
    global.jest = jest;
    ...
    console.log('✅ Comprehensive mocks set up');
}
...
async function runTests() {
    console.log('================================================================================');
    console.log('🧪 WishCart Extension - Fixed Test Runner');
    console.log('📊 Fixed Test Execution with Proper Jest Support');
    console.log('================================================================================');
    
    const overallStartTime = Date.now();
    
    // Setup - IMPORTANT: Setup mocks BEFORE test environment
    setupMocks();
    ...
    console.log('🚀 Starting Fixed Test Execution...');
    console.log();
...
if (require.main === module) {
    runTests().catch(error => {
        console.error(`💥 Fixed test runner error: ${error.message}`);
        process.exit(1);
    });
}
